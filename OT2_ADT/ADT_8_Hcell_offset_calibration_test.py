...
metadata = {"protocolName": "ADT_8_Hcell_Offset_Calibration",
            "author": "Pozzo Research Group",
            "description": "Protocol to use for establishing the individual labware offsets for the 8-Hcell diffusion testing layout.",
            "apiLevel": '2.8'
}
...
def run(protocol: protocol_api.ProtocolContext):
    ...
    dest_3 = protocol.load_labware('adt_hcell_9_10', 7)
    dest_4 = protocol.load_labware('adt_hcell_1_2', 10)
    dest_5 = protocol.load_labware('corning_96_wellplate_360ul_flat', 6)
    dest_6 = protocol.load_labware('corning_96_wellplate_360ul_flat', 9)
